    ...
    <div className="space-y-10">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
        <div className="space-y-1">
          <h1 className="text-4xl font-headline font-bold uppercase tracking-wider">Settings</h1>
          <p className="text-sm text-muted-foreground">Configure your boutique&apos;s core behavior and external channels.</p>
        </div>
        <Button 
          onClick={handleSave} 
          disabled={isSaving}
      ...
      <Tabs defaultValue="general" className="space-y-8">
        <TabsList className="bg-white p-1 rounded-2xl shadow-sm border border-slate-100 h-auto self-start">
          ...
          <TabsTrigger value="payments" className="rounded-xl px-6 py-2.5 text-[10px] font-bold uppercase tracking-widest data-[state=active]:bg-primary data-[state=active]:text-white transition-all">
            <CreditCard className="h-3.5 w-3.5 mr-2" /> Payments & Shipping
          </TabsTrigger>
          <TabsTrigger value="storefront" className="rounded-xl px-6 py-2.5 text-[10px] font-bold uppercase tracking-widest data-[state=active]:bg-primary data-[state=active]:text-white transition-all">
            <Layout className="h-3.5 w-3.5 mr-2" /> Storefront
          </TabsTrigger>
        </TabsList>
            ...
            <div className="lg:col-span-2 space-y-6">
              <Card className="border-none shadow-sm rounded-3xl overflow-hidden bg-white">
                <CardHeader className="p-8 pb-4">
                  ...
                  <CardDescription className="text-xs">Basic information that appears across the site.</CardDescription>
                </CardHeader>
                <CardContent className="p-8 pt-4 space-y-6">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="space-y-2">
                      <Label className="text-[10px] font-bold uppercase tracking-widest text-muted-foreground ml-1">Boutique Name</Label>
                    ...
                    <div className="space-y-2">
                      ...
                      <Input defaultValue="+91 88888 99999" className="h-12 rounded-xl border-slate-100 bg-slate-50/50" />
                    </div>
                    <div className="space-y-2">
                      <Label className="text-[10px] font-bold uppercase tracking-widest text-muted-foreground ml-1">Instagram Handle</Label>
                      <Input defaultValue="@pehnavabyneha" className="h-12 rounded-xl border-slate-100 bg-slate-50/50" />
                    </div>
                  </div>
                  <div className="space-y-2">
                    <Label className="text-[10px] font-bold uppercase tracking-widest text-muted-foreground ml-1">Studio Address</Label>
                    <Input defaultValue="45-A, Heritage Lane, Mansarovar, Jaipur, Rajasthan 302020" className="h-12 rounded-xl border-slate-100 bg-slate-50/50" />
                  </div>
                </CardContent>
              </Card>
            </div>
            ...
            <div className="space-y-6">
              <Card className="border-none shadow-sm rounded-3xl overflow-hidden bg-slate-900 text-white">
                <CardContent className="p-8 space-y-6">
                  ...
                  <div className="space-y-2">
                    <h4 className="text-xl font-headline font-bold uppercase tracking-widest text-accent">Security Mode</h4>
                    <p className="text-xs text-white/60 leading-relaxed">
                      All administrative changes are logged and tracked. Keep your session secure.
                    </p>
                  </div>
        ...
        <TabsContent value="payments" className="space-y-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            <Card className="border-none shadow-sm rounded-3xl overflow-hidden bg-white">
              <CardHeader className="p-8 pb-4">
                <CardTitle className="text-xl font-headline font-bold uppercase tracking-widest">Payment Configuration</CardTitle>
              ...
              <CardContent className="p-8 pt-4 space-y-8">
                <div className="p-6 rounded-2xl border-2 border-primary/10 bg-primary/5 space-y-4">
                  ...
                  <div className="space-y-2 pt-2">
                    ...
                    <p className="text-[9px] text-muted-foreground italic font-medium">* Customers will see this ID during checkout.</p>
                  </div>
                </div>
                ...
                <div className="flex items-center justify-between p-2">
                  <div className="space-y-0.5">
                    ...
                    <p className="text-xs text-muted-foreground">Allow COD for selected locations.</p>
                  </div>
            ...
            <Card className="border-none shadow-sm rounded-3xl overflow-hidden bg-white">
              <CardHeader className="p-8 pb-4">
                <CardTitle className="text-xl font-headline font-bold uppercase tracking-widest">Shipping & Delivery</CardTitle>
                <CardDescription className="text-xs">Set thresholds and default delivery parameters.</CardDescription>
              </CardHeader>
              <CardContent className="p-8 pt-4 space-y-8">
                <div className="space-y-4">
                  ...
                  <div className="space-y-2">
                    <Label className="text-[10px] font-bold uppercase tracking-widest text-muted-foreground ml-1">Estimated Delivery Days</Label>
                    <Input defaultValue="5-7 Days" className="h-12 rounded-xl border-slate-100 bg-slate-50/50" />
                  </div>
                </div>
              </CardContent>
            </Card>
        ...
        <TabsContent value="storefront" className="space-y-6">
          <Card className="border-none shadow-sm rounded-3xl overflow-hidden bg-white">
            <CardHeader className="p-8 pb-4">
              <CardTitle className="text-xl font-headline font-bold uppercase tracking-widest">Layout & Content</CardTitle>
              <CardDescription className="text-xs">Dynamic content displayed on the boutique storefront.</CardDescription>
            </CardHeader>
            <CardContent className="p-8 pt-4 space-y-10">
              <div className="space-y-4">
                <h5 className="text-sm font-bold uppercase tracking-widest border-b pb-2 text-primary">Announcement Bar</h5>
                <div className="space-y-4">
                  <div className="flex items-center justify-between">
                    <Label className="text-xs font-medium">Show Announcement Bar</Label>
                    <Switch checked={true} />
                  </div>
                  <div className="space-y-2">
                    ...
                    <textarea 
                      className="w-full min-h-[100px] rounded-2xl border-slate-100 bg-slate-50/50 p-4 text-xs font-medium focus:ring-primary/20 outline-none ring-2 ring-transparent transition-all"
              ...
              <div className="space-y-4 pt-4">
                <h5 className="text-sm font-bold uppercase tracking-widest border-b pb-2 text-primary">Interactive Features</h5>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                  <div className="flex items-center justify-between p-4 rounded-2xl bg-slate-50 border border-slate-100">
                    <div className="space-y-0.5">
                      <h6 className="text-xs font-bold">Recent Purchase Popups</h6>
                      <p className="text-[10px] text-muted-foreground">Show social proof notification.</p>
                    </div>
                    <Switch checked={true} />
                  </div>
                  <div className="flex items-center justify-between p-4 rounded-2xl bg-slate-50 border border-slate-100">
                    <div className="space-y-0.5">
                      <h6 className="text-xs font-bold">AI Assistant Chat</h6>
                      <p className="text-[10px] text-muted-foreground">Enable Genkit boutique helper.</p>
                    </div>
                    <Switch checked={true} />
                  </div>
                </div>
